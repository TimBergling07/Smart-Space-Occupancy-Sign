                    ...
                    */
                    int predict(float *x) {
                        ...
                        if (x[2] <= 305.0218811035156) {
                            ...
                            if (x[2] <= 649.1343994140625) {
                                if (x[2] <= 642.2818603515625) {
                                    votes[1] += 1;
                                }
                        ...
                        if (x[0] <= 0.00634397380053997) {
                            ...
                            if (x[0] <= 0.006889137206599116) {
                                if (x[1] <= 3.0) {
                                    if (x[2] <= 688.3422241210938) {
                                        if (x[0] <= 0.006641061510890722) {
                                            votes[1] += 1;
                                        }
                        ...
                        if (x[2] <= 305.0218811035156) {
                            if (x[0] <= 0.0039816314820200205) {
                                ...
                                if (x[3] <= 0.6453867852687836) {
                                    if (x[3] <= 0.6020472049713135) {
                                        if (x[3] <= 0.44483333826065063) {
                                            votes[1] += 1;
                                        }
